# day87_agent_project_final/app.py
import os
import sys
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', 'phase4-agents', 'day47_project2_start'))
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', 'phase4-agents', 'day48_project2_tools'))
...
st.title("🔍 Ecommerce Market Research Agent")
...
with col2:
    ...
    if run_btn:
        ...
        with st.spinner(f"Agent researching {category} market... 30-60 seconds"):
        ...
        st.info("Configure your research settings and click Run Research.")

st.divider()
st.markdown(
    "<p style='text-align:center;color:#888;font-size:0.8rem;'>Project 2 — Market Research Agent | 100 Days of AI/ML Day 87</p>",
    unsafe_allow_html=True
)